...
| `agents/memory_compressor.py` | Автоматическое сжатие lessons для PostMortem и Regime Trust | **Обновлён**: структурированные карточки с экшенами, фильтр дублей, хэширование | Зависит от стабильности LLM JSON, нет офлайн fallback | Добавить локальный пайплайн компрессии, расширить схему БД под структурные поля |
